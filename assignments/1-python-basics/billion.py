...
def time_to_billion_seconds(age):
    ...
    age_seconds = age * DAYS_PER_YEAR * HOURS_PER_DAY \
                      * MINUTES_PER_HOUR * SECONDS_PER_MINUTE
    seconds_remaining = 1e9 - age_seconds

    # Split the total number of days remaining into years and days.
    total_days_remaining = seconds_remaining / (SECONDS_PER_MINUTE
                                                * MINUTES_PER_HOUR
                                                * HOURS_PER_DAY)
    ...
    print(f"You have {years_remaining} years and {days_remaining} days until"
