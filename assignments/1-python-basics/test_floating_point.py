...
@pytest.mark.parametrize("bit_string,sign,exponent,fraction", [
    # These cases were randomly generated.
    ("00000111100100000101111001010110", "0", "00001111",
     "00100000101111001010110"),
    ("11101011100110010100011000000001", "1", "11010111",
     "00110010100011000000001"),
    ("00111111000100000111111000101000", "0", "01111110",
     "00100000111111000101000"),
    ("01011111100111100100001001101101", "0", "10111111",
     "00111100100001001101101"),
    ("01100011010100111110001000010101", "0", "11000110",
     "10100111110001000010101"),
    ("00100100001001001010010101100110", "0", "01001000",
     "01001001010010101100110"),
    ("10000010110000011110011101011000", "1", "00000101",
     "10000011110011101011000"),
    ("10100111110111101111100111100000", "1", "01001111",
     "10111101111100111100000"),
    ("00111011110010100101101101110001", "0", "01110111",
     "10010100101101101110001"),
    ("11010110010100000001011100110010", "1", "10101100",
...
@pytest.mark.parametrize("exponent,power", [
    # These cases were randomly generated.
    ("01100110", -25),
    ("11001010", 75),
    ("11100101", 102),
...
@pytest.mark.parametrize("fraction, significand", [
    # These cases were randomly generated.
...
@pytest.mark.parametrize("bit_string,converted_float", [
    # These cases were randomly generated.
    ...
    ("11100110010010010100010110000000", -2.3761942794248038e+23),
